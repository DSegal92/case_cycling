...
class OfficersControllerTest < ActionController::TestCase
  ...
  test "should create officer" do
    assert_difference('Officer.count') do
      post :create, officer: { bio: @officer.bio, contact: @officer.contact, majors: @officer.majors, minors: @officer.minors, name: @officer.name, picture: @officer.picture }
    end
  ...
  test "should update officer" do
    put :update, id: @officer, officer: { bio: @officer.bio, contact: @officer.contact, majors: @officer.majors, minors: @officer.minors, name: @officer.name, picture: @officer.picture }
    assert_redirected_to officer_path(assigns(:officer))
  end
