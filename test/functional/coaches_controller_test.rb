...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { bio: @coach.bio, contact: @coach.contact, name: @coach.name, picture: @coach.picture }
    end
  ...
  test "should update coach" do
    put :update, id: @coach, coach: { bio: @coach.bio, contact: @coach.contact, name: @coach.name, picture: @coach.picture }
    assert_redirected_to coach_path(assigns(:coach))
  end
